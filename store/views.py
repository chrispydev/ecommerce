...
class AddToCartView(View):
   def post(self, request, *args, **kwargs):
    ...
    total_price = cart.cartitem_set.aggregate(total_price=Sum('price'))['total_price']

    # Calculate the total count of items in the cart
    cart_count = CartItem.objects.filter(cart=cart).aggregate(total_count=Sum('quantity'))['total_count']
...
class CartItemsView(View):
    def get(self, request):
        ...
        return JsonResponse({'cart_items': serialized_cart_items, 'total_quantity': total_quantity})
